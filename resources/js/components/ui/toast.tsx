...
export default function Toast({description} : ToastProps) {
    ...
    return (
        <>
            ...
            {open && (
                <div id="toast-success" className="fixed top-5 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm " role="alert">
                    ...
                    <p className="ms-3 text-sm font-normal text-gray-800">
                        {description}
                    </p>
